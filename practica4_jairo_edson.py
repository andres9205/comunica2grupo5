...
class practica4_jairo_edson(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ber_comu2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ber_comu2")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica4_jairo_edson")
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "# bits por simbolo", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._No_range = Range(0, 0.8, 0.0001, 0.2, 200)
        self._No_win = RangeWidget(self._No_range, self.set_No, "Amplitud del ruido", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(1, samp_rate, samp_rate/2-(samp_rate/10), 1000, window.WIN_HAMMING, 6.76), 1)
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.digital_binary_slicer_fb_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.samp_rate/2-(self.samp_rate/10), 1000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=practica4_jairo_edson, options=None):
