...
class practica1_labcomu2_subgrupo5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PRACTICAANCHO DE BANDA", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PRACTICAANCHO DE BANDA")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica1_labcomu2_subgrupo5")
        ...
        self._N0_range = Range(1E-6, 0.5, 1E-6, 0.250, 200)
...
def main(top_block_cls=practica1_labcomu2_subgrupo5, options=None):
